...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-success"><i class="fas fa-fw fa-plus"></i> Tambah Data Covid-19</h6>
    </div>

    <?php echo form_open('Admin/tambah_covid', array('class' =>
    'form-horizontal')); ?>
