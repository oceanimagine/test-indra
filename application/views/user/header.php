...
<head>
  ...
  <title>Klasterisai Risiko Penyebaran COVID-19</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('User') ?>">
        ...
        <div class="sidebar-brand-text mx-3">CLUSTERING K-MEDOIDS</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('User/covid') ?>">
